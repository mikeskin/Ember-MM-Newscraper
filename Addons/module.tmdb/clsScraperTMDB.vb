...
#Region "Methods"
        ...
        Private Function ConvertVideoQuality(ByRef Size As Integer) As Enums.TrailerVideoQuality
        ...
        Private Function ConvertVideoType(ByRef Type As String) As Enums.TrailerType
        ...
        Public Sub GetID_Movie(ByVal DBMovie As Database.DBElement)
            ...
            APIResult = Task.Run(Function() _TMDBApi.GetMovieAsync(DBMovie.Movie.IMDB))
        ...
        Public Function GetID_Movie(ByVal imdbID As String) As String
            Dim Movie As TMDbLib.Objects.Movies.Movie
        ...
        Public Function GetID_MovieCollection(ByVal imdbID As String) As String
            Dim Movie As TMDbLib.Objects.Movies.Movie
        ...
        Public Function GetID_TMDBbyIMDB(ByVal imdbID As String) As String
        ...
        Public Function GetID_TMDBbyTVDB(ByVal tvdbID As String) As String
            Dim tmdbID As String = String.Empty
        ...
        Public Function GetInfo_Movie(ByVal strID As String, ByVal FilteredModifiers As Structures.ScrapeModifiers, ByVal FilteredOptions As Structures.ScrapeOptions) As MediaContainers.ScrapeResultsContainer
            ...
            Dim strLanguage As String = String.Concat(_TMDBApi.DefaultLanguage.Substring(0, 2), ",en,null")

            If strID.StartsWith("tt") Then
                'search movie by IMDB ID
                APIResult = Task.Run(Function() _TMDBApi.GetMovieAsync(strID, strLanguage, TMDbLib.Objects.Movies.MovieMethods.Credits Or TMDbLib.Objects.Movies.MovieMethods.Images Or TMDbLib.Objects.Movies.MovieMethods.Releases Or TMDbLib.Objects.Movies.MovieMethods.Videos))
                If _SpecialSettings.FallBackEng Then
                    APIResultE = Task.Run(Function() _TMDBApiE.GetMovieAsync(strID, "en", TMDbLib.Objects.Movies.MovieMethods.Credits Or TMDbLib.Objects.Movies.MovieMethods.Releases Or TMDbLib.Objects.Movies.MovieMethods.Videos))
                Else
                    APIResultE = APIResult
                End If
            Else
                'search movie by TMDB ID
                APIResult = Task.Run(Function() _TMDBApi.GetMovieAsync(CInt(strID), strLanguage, TMDbLib.Objects.Movies.MovieMethods.Credits Or TMDbLib.Objects.Movies.MovieMethods.Images Or TMDbLib.Objects.Movies.MovieMethods.Releases Or TMDbLib.Objects.Movies.MovieMethods.Videos))
                If _SpecialSettings.FallBackEng Then
                    APIResultE = Task.Run(Function() _TMDBApiE.GetMovieAsync(CInt(strID), "en", TMDbLib.Objects.Movies.MovieMethods.Videos))
                Else
                    APIResultE = APIResult
                End If
            End If
            ...
            'IDs
            nScrapeResults.Movie.TMDB = CStr(Result.Id)
            If Result.ImdbId IsNot Nothing Then nScrapeResults.Movie.IMDB = Result.ImdbId
            ...
            If (FilteredModifiers.MainExtrafanarts OrElse FilteredModifiers.MainExtrathumbs OrElse FilteredModifiers.MainFanart) AndAlso Result.Images.Backdrops IsNot Nothing Then
                For Each tImage In Result.Images.Backdrops
                    Dim newImage As New MediaContainers.Image With {
                            ...
                            .URLOriginal = String.Concat(_TMDBApi.Config.Images.BaseUrl, "original", tImage.FilePath),
                            .URLThumb = String.Concat(_TMDBApi.Config.Images.BaseUrl, "w300", tImage.FilePath),
            ...
            If FilteredModifiers.MainPoster AndAlso Result.Images.Posters IsNot Nothing Then
                For Each tImage In Result.Images.Posters
                    Dim newImage As New MediaContainers.Image With {
                                ...
                                .ShortLang = If(String.IsNullOrEmpty(tImage.Iso_639_1), String.Empty, tImage.Iso_639_1),
                                .URLOriginal = String.Concat(_TMDBApi.Config.Images.BaseUrl, "original", tImage.FilePath),
                                .URLThumb = String.Concat(_TMDBApi.Config.Images.BaseUrl, "w185", tImage.FilePath),
                                .VoteAverage = tImage.VoteAverage.ToString,
                                .VoteCount = tImage.VoteCount,
                                .Width = tImage.Width.ToString}
        ...
        Public Function GetInfo_MovieSet(ByVal strID As String, ByVal FilteredOptions As Structures.ScrapeOptions) As MediaContainers.MovieSet
        ...
        Public Function GetInfo_TVEpisode(ByVal ShowID As Integer, ByVal Aired As String, ByRef FilteredOptions As Structures.ScrapeOptions) As MediaContainers.EpisodeDetails
            ...
            For Each aSeason As TMDbLib.Objects.TvShows.TvSeason In ShowInfo.Seasons
                ...
                If EpisodeList IsNot Nothing AndAlso EpisodeList.Count = 1 Then
                    Return GetInfo_TVEpisode(EpisodeList(0), FilteredOptions)
            ...
            If APIResult IsNot Nothing AndAlso APIResult.Exception Is Nothing AndAlso APIResult.Result IsNot Nothing Then
                ...
                If ScrapeModifiers.withEpisodes AndAlso SeasonInfo.Episodes IsNot Nothing Then
                    For Each aEpisode As TMDbLib.Objects.TvShows.TvEpisode In SeasonInfo.Episodes
                        nTVShow.KnownEpisodes.Add(GetInfo_TVEpisode(aEpisode, FilteredOptions))
        ...
        ''' <returns>True: success, false: no success</returns>
        Public Function GetInfo_TVShow(ByVal strID As String, ByRef ScrapeModifiers As Structures.ScrapeModifiers, ByRef FilteredOptions As Structures.ScrapeOptions) As MediaContainers.TVShow
            If String.IsNullOrEmpty(strID) OrElse strID.Length < 2 Then Return Nothing
        ...
        Public Function Search_Movie(ByVal strTitle As String, Optional ByVal iYear As Integer = 0) As MediaContainers.SearchResultsContainer
            If String.IsNullOrEmpty(strTitle) Then Return Nothing

            Dim nSearchResults As New MediaContainers.SearchResultsContainer
                    ...
                    If Movies.Results IsNot Nothing Then
                        For Each aMovie In Movies.Results
                            ...
                            Dim lNewMovie As MediaContainers.Movie = New MediaContainers.Movie With {.OriginalTitle = tOriginalTitle,
                                                                                                     ...
                                                                                                     .TMDB = CStr(aMovie.Id),
                                                                                                     .Year = tYear}
                            nSearchResults.Movies.Add(lNewMovie)
                        Next
                    End If
                    Page = Page + 1
                    If aE Then
        ...
        Public Function Search_MovieSet(ByVal strTitle As String) As List(Of MediaContainers.MovieSet)
        ...
        Public Function Search_TVShow(ByVal strShow As String) As List(Of MediaContainers.TVShow)
