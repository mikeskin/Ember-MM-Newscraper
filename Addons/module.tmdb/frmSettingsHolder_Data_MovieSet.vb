...
Public Class frmSettingsHolder_Data_MovieSet
...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDown.Click
        'Dim order As Integer = ModulesManager.Instance.externalScraperModulesSettingsPanels_Data_MovieSet.FirstOrDefault(Function(p) p.AssemblyName = clsModuleTMDB._AssemblyName).ModuleOrder
    ...
    Private Sub cbEnabled_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkEnabled.CheckedChanged
        RaiseEvent ModuleStateChanged(chkEnabled.Checked, Enums.SettingsPanelType.MovieSetData, 0)
    End Sub
    ...
    Sub orderChanged()
        'Dim order As Integer = ModulesManager.Instance.externalScraperModulesSettingsPanels_Data_MovieSet.FirstOrDefault(Function(p) p.AssemblyName = clsModuleTMDB._AssemblyName).ModuleOrder
        'If ModulesManager.Instance.externalScraperModulesSettingsPanels_Data_MovieSet.Count > 1 Then
        '    btnDown.Enabled = (order < ModulesManager.Instance.externalScraperModulesSettingsPanels_Data_MovieSet.Count - 1)
